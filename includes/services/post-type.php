...
add_action('init', 'register_post_types_service', 0);
function register_post_types_service() {
    register_post_type('service', [
        ...
        'hierarchical' => true,
        'supports' => ['title', 'layout-attributes', 'thumbnail'], // 'title','editor','author','thumbnail','dashicons-admin-tools','trackbacks','custom-fields','comments','revisions','layout-attributes','post-formats'
        'taxonomies' => [],
        'has_archive' => true,
        'rewrite' => true,
        'query_var' => true,
...
function create_service_taxonomies() {
    ...
    register_taxonomy('service_label', 'service', array(
        'hierarchical' => false,
        'labels' => array(
            ...
            'add_new_item' => __('Добаваить Метку'),
